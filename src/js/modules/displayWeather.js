...
export function displayWeather(weather) {
  ...
  output.innerHTML = `
    <div class="bg-vintage-pattern p-4 max-w-md w-full mx-auto border-4 border-double border-zinc-900/90">
      <h2 class="text-3xl text-zinc-900/90 mb-4 text-center">${weather.location}</h2>
      ...
      <p class="text-zinc-800/90 mb-4 text-center font-body">Feels like ${weather.feelsLike}°C</p>

      <div class="space-y-2 text-left text-sm mb-4">
        <p class="italic text-zinc-50 text-lg text-center font-body bg-zinc-900/95 px-2.5 py-3 mb-4 border border-zinc-900/90 rounded-xs">${doomDescription}</p>
